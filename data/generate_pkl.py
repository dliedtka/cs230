...
while (line and counter < 96655):
    ...
    # error articles (skip)
    error_articles = [41876, 55042, 55043, 55044, 60492, 60493, 60494, 60827, 60828, 60829, 60886, 60887, 60888, 65220, 65221, 65222, 69606, 69607, 69608, 77757, 77758] + range(96508, 96517) + range(96522, 96565) + range(96596, 96596+39)
    ...
    if counter >= 0 and counter < 142:
        ...
        month = int(date[1])
        day = int(date[2])
        publication = article_space[-3].strip()
        length = int(article_space[-1].strip())
        content = ""
    ...
    # 1 line article entries
        ...
        # publication
        publication = content_space[-3].strip()

        # length
        length = int(content_space[-1].strip())
